                ...
                <article
                    ...
                    <div class="p-5">
                        ...
                        <a class="group  relative inline-flex items-center overflow-hidden rounded bg-indigo-600 px-8 py-3 text-white focus:outline-none focus:ring active:bg-indigo-500"
                            href="{{route('subcategoria.productos' , $subcategoria ->  id)}}"> {{-- ? le pasamos la id padre de esa subcategoria , para que coja todos los productos en la tabla producto donde el atributo category_id tenga el mismo id que se pasa por esa ruta --}}
