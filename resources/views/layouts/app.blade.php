    ...
    <footer class="bg-white" aria-labelledby="footer-heading">
        ...
        <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
          <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="space-y-8">
              <img class="h-36 w-50" src="{{Storage::url('7.svg')}}" alt="">
              ...
              <div class="flex space-x-6">
                ...
                <a href="#" class="text-gray-400 hover:text-gray-500" aria-label="X">
                ...
                <a href="#" class="text-gray-400 hover:text-gray-500" aria-label="Youtube">
            ...
            <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              ...
              <div class="flex justify-center">
                  Aqui va lo de isabel
              </div>
            </div>
          </div>
          <div class="mt-16 border-t border-gray-900/10 flex pt-8 sm:mt-20 lg:mt-24">
            <p class="text-xs leading-5 text-gray-500">&copy; 2020 Tu Empresa, S.A. Todos los derechos reservados.</p>
          </div>
        </div>
      </footer>
