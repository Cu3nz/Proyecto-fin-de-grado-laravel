                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('category.edit', $item->id) }}"><i
                                            class="fas fa-edit text-yellow-600 mr-2"></i></a> {{-- todo Boton para actualizar --}}
                ...
                <div class="h-screen w-screen mb-30 bg-gray-100 flex items-center">
                    <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
                        <div class="max-w-md">
                            ...
                            <p class="text-2xl md:text-3xl font-light leading-normal">Lo sentimos pero no se ha
                                encontrado ninguna categoria con ese nombre </p>
