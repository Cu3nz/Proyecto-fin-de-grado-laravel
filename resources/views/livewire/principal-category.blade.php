        ...
        <div class="relative overflow-x-auto">
            ...
            @else
                ...
                <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
                      ...
                      <a href="{{route('Category.principal')}}" class="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-blue-600 active:bg-blue-600 hover:bg-blue-700">Volver a la pagina principal</a>
                </div>
                  <div class="max-w-lg">
