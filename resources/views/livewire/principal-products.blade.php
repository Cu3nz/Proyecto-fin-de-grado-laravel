                            ...
                            <tr
                                ...
                                @endphp --}}
                                    @if ($item->primeraImagen)
                                        <img src="{{ Storage::url($item->primeraImagen->url_imagen) }}"
                                            class="w-16 md:w-32 max-w-full max-h-full rounded-lg shadow-md"
                                            alt="{{ $item->primeraImagen->desc_imagen }}">
                                    @else
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <input type="text" readonly id="first_product"
                                                @class([
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    <button wire:click="pedirConfirmacion({{ $item->id }})" type="button"
        ...
        <div class="h-screen w-screen mb-30 bg-gray-100 flex items-center">
            <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
                <div class="max-w-md">
                    ...
                    <p class="text-2xl md:text-3xl font-light leading-normal">Lo sentimos pero no se ha encontrado
                        ninguna categoria con ese nombre </p>
