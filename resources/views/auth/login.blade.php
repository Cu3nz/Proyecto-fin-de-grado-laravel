    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mt-4 flex flex-col md:flex-row justify-center">
                <a class="flex items-center bg-white border border-gray-300 rounded-md shadow-sm px-4 py-2 text-sm font-medium text-gray-700" href="{{ route('google.redirect') }}">
                    <img class="w-5 mr-2" src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c1/Google_%22G%22_logo.svg/800px-Google_%22G%22_logo.svg.png">
           ...
           {{--  <div class="mt-4">
                <a href="{{route('google.redirect')}}">Login con google</a>
            </div> --}}
